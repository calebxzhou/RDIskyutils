...
public class SkyutilsMod implements ModInitializer {
	...
	public static final Hammer WOODEN_HAMMER = new Hammer(Tiers.WOOD, 1, -1.8F,
			(new Item.Properties()).tab(ITEM_GROUP));
	public static final Hammer STONE_HAMMER = new Hammer(Tiers.STONE, 2, -2.8F,
			(new Item.Properties()).tab(ITEM_GROUP));
	public static final Hammer IRON_HAMMER = new Hammer(Tiers.IRON, 4, -3.0F,
			(new Item.Properties()).tab(ITEM_GROUP));
	public static final Hammer DIAMOND_HAMMER = new Hammer(Tiers.DIAMOND, 8, -3.2F,
			(new Item.Properties()).tab(ITEM_GROUP));
/*	public static final Hammer NETHERITE_HAMMER = new Hammer(Tiers.NETHERITE, 12, -3.8F,
			(new Item.Properties()).tab(ITEM_GROUP));
